...
int mainMenu(const ExMessage& msg)
{
    ...
    drawtext("学生成绩管理系统", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
...
void iinsert()
{
    ...
    //char title[50] = "添加学生";
    RECT r = { 0, 0, 900, 250 };
    drawtext("添加学生", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);

    settextstyle(30, 0, "黑体");
    r = { 0, 0, 900, 400 };
    drawtext("请依次输入<学号 姓名 性别 班级 成绩1 成绩2 成绩3>", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
...
void eerase()
{
    settextstyle(50, 0, "黑体");
    RECT r = { 0, 0, 900, 200 };
    drawtext("删除学生", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
    settextstyle(30, 0, "黑体");
    r = { 0, 150, 900, 250 };
    drawtext("请输入需要删除的学生学号", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
    ...
    if (delEdit.pos != -1)
    {
        ...
        drawtext("学生信息：", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
...
void modify()
{
    settextstyle(50, 0, "黑体");
    RECT r = { 0, 0, 900, 200 };
    drawtext("修改学生", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
    //    for (int i = 0; i < 8; i++)
    //	{
    //		S_Edit(modifys[i]);
    //	}
    settextstyle(30, 0, "黑体");
    r = { 0, 150, 900, 250 };
    drawtext("请输入需要修改的学生学号", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
    Editshow(modifyEdit);
    ...
    else
    {
        ...
        r = { 50, 360, 850, 390 };
        if (isfirst)
            drawtext("未找到你要修改的学生，请查证后重试！", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
        else
            drawtext("请在上方输入框中输入要查找的学生学号，然后点击此处信息直接编辑！", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
    }
}
/** \brief 查
 *
...
void ffind()
{
    settextstyle(50, 0, "黑体");
    RECT r = { 0, 0, 900, 200 };
    drawtext("查找学生", &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
    settextstyle(20, 0, "宋体");
